...
<html>
    ...
    <body>
		   ...
		   try{
               ...
               String name=request.getParameter("InfoUpdateName");
			   String op=request.getParameter("select");
			   String change=request.getParameter("InfoUpdate");
         ...
         Element changEl=parent.element(op);
         ...
         try {  
             ...
             writer.write(doc);  
             writer.close();  
			out.println("<script>alert('修改成功！');window.location.href='employee_ad.html';</script>");
         } catch (Exception ex) {  
             ex.printStackTrace();  
		}  
     } catch (Exception ex) {  
